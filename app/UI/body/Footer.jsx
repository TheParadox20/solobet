...
export default function Footer(){
    return(
        <footer className="border-t-[1px] border-Grey px-4 py-4 mt-8">
            <div className="flex flex-col md:flex-row gap-y-6 justify-between py-6">
                <div className="md:w-1/4">
                    <Logo/>
                    <p className="my-3 text-sm">
                    Kenya{'\''}s first betting exchange. Join us today for <Link className="" href={'/test'}>an</Link> unmatched betting experience and enjoy instant payouts via M-Pesa.
                    </p>
